...
export default function Signup({setPage, onClose}: SignUpProps){
      ...
      <div className="min-h-screen w-screen sm:w-sm flex justify-center items-center">
        <div className="relative w-full h-screen sm:h-fit px-8 py-8 bg-white border shadow-md rounded-md">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-2">We&apos;re excited to have you join us</p>
          </div>
          <form className="py-4 space-y-3" onSubmit={registerUser}>
            ...
            <button 
              type='submit'
              className={`w-full mt-3 py-2 bg-black text-white font-medium rounded-md ${loading ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'} hover:opacity-80`}
              disabled={loading}
            >
              Sign Up
            </button>
